...
function visHandlekurv() {
    ...
    if (knappTrykket === true) {
        ...
        KURV_IKON.innerHTML = `<img id="minHandlekurvLogo" src="./images/shopping-cart-icon-2.png">`;
    }
...
const bildeGalleri = ["./images/inspiration/inspiration-1.jpg", "./images/inspiration/inspiration-2.jpg", "./images/inspiration/inspiration-3.jpg", "./images/inspiration/inspiration-4.jpg"];
...
function visBildegalleri() {
    ...
    if (inspirasjonTrykket === true) {
        ...
        inspirasjon.innerHTML = `<img src="./images/inspiration/inspiration-1.jpg" alt="bilde av rom stilig innredet">`
